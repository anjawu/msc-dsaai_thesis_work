...
est_files_path = "/Users/anjawu/Code/msc-dsaai_thesis_work/estimating_parameters/"
summary_path = paste0(est_files_path, 'MCMC_output/summary/')
...
# save:
# for (i in 1:N) {
#   saveRDS(individuals_bic_df[[i]], file = paste0(est_files_path, "individual_bic_scores/individual_", i, "_bic_df.rds"))
# }

# Read back info:
for (i in 1:N) {
  individuals_bic_df[[i]] <- readRDS(paste0(est_files_path, "individual_bic_scores/individual_", i, "_bic_df.rds"))
}
```
...
```{r boxplots}
plot_path <- paste0(est_files_path, 'individual_bic_scores/boxplots/')
